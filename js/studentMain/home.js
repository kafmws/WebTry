...
$(function(){
	...
	var planetTravelConfig = {
		flyStarImage	: [ [ ROOT_URL +'./res/pic/studentMain/star-fly-1.png' , 23 ,23 ] ],
		flashStarImage	: [ [ ROOT_URL +'./res/pic/studentMain/star-flash-1.png' , 30 ,27 ] , [ ROOT_URL +'./res/pic/studentMain/star-flash-2.png' , 40 ,40 ], [ ROOT_URL +'./res/pic/studentMain/star-flash-2.png' , 40 ,40 ] ],
