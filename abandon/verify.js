function verify(window, document) {
    var SliderBar = function (targetDom, options) {
        ...
        if (dataList.length > 0) {
            this.targetDom.innerHTML = "<div class='slide-box'><div class='slide-img-block'>" +
                "<div class='slide-loading'></div><div class='slide-img-border'>" +
                "<div class='scroll-background slide-top'></div><div class='slide-img-div'>" +
                "<div class='slide-img-nopadding'><img class='slide-img' id='slideImg' src='' alt=''/>" +
